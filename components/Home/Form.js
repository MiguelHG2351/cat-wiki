            ...
            Search
				...
				<div style={ { display: menu ? 'block' : 'none' } } className="modal-mobile fixed z-20 top-0 left-0 right-0 bottom-0 py-2 px-4 bg-white">
					...
					<div className="input-mobile-container group relative">
						<input id={inputId} onInput={ onInputHandler } ref={ mobileInputRef } className=" border-black border w-full my-7 rounded-lg py-2 px-3 placeholder:text-black" type="text" name="search-modal" placeholder="Search for a cat" />
